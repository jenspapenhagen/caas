...
docker build -t base/prometheus .
docker remove localhost:5000/base/prometheus
docker push localhost:5000/base/prometheus
docker kill base/prometheus
docker rm base/prometheus
